...
export default {
	...
	sources: [
		{
			url: 'https://www.machineacalculer.fr/notices/1007.pdf',
			title: "Notice d'utilisation de la Triumphator CRN1",
			iconUrl: 'https://machineacalculer.fr/wp-includes/images/w-logo-blue-white-bg.png'
		}
	]
} satisfies Image;
